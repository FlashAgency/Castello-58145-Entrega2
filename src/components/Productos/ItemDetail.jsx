  ...
  return (
    <Container maxW='6xl' py='32'>
      <Flex width='100%' justifyContent='space-between' gap='24px' columns={2}>
        <Flex justify='center'>
          <Image boxSize='400' borderRadius='xl' border='2px' borderColor='#ACB75A' src={item.image} />
        </Flex>
          <Container maxW='2xl' m='0' p='0'>
        <Stack divider={<StackDivider borderColor='#ACB75A' />} direction='column' spacing='6'>
          <Flex direction='column' align='center' gap="6">
            <Heading color='gray.700' size='2xl'>{item.name}</Heading>
            <Text color='#ACB75A' as='b' fontSize='3xl'>$ {item.price}</Text>
          </Flex>
          <Flex>
